...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if((year >= 1582) && (year%4 == 0))
        {
            ...
            else System.out.println(year + " SZÖKŐÉV");
...
/*
        ...
        scanner.nextLine();
        int kozososzto = 0;
        int kisebb = szam>=szam2?szam2:szam;
        ...
        for(int i = 1; i<=kisebb; i++)
        {
            ...
            {
                kozososzto = i;
                System.out.println("Közös osztók: " + i);
            }

        }
        System.out.println("Legnagyobb közös osztó: " +  kozososzto);
